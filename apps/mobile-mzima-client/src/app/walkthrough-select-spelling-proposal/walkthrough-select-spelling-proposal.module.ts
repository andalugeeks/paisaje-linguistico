...
import { WalkthroughSelectSpellingProposalPageRoutingModule } from './walkthrough-select-spelling-proposal-routing.module';
...
@NgModule({
  imports: [
    ...
    TranslateModule,
    SortByFieldModule,
    WalkthroughSelectSpellingProposalPageRoutingModule,
  ],
  declarations: [WalkthroughSelectSpellingProposalPage, ...components],
})
export class WalkthroughSelectSpellingProposalPageModule {}
